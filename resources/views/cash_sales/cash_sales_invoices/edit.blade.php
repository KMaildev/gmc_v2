...
@section('content')
    <div class="row invoice-add justify-content-center">
        <div class="col-lg-9 col-12 mb-lg-0 mb-4">
            <form action="{{ route('cash_sales_invoices.update', $sales_invoice_edit->id) }}" method="POST" autocomplete="off"
                id="edit-form">
                @csrf
                @method('PUT')
                <input type="hidden" name="sales_invoices_payments_id" value="{{ $sales_invoices_payments_edit->id }}">
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                ...
                                                value="{{ $sales_invoice_edit->post_ref ?? '' }}" name="post_ref">
                                            @error('post_ref')
                                                <div class="invalid-feedback"> {{ $message }} </div>
                                            @enderror
                                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($temporary_sales_items as $key => $temporary_sales_item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('temporary_sales_items_delete', $temporary_sales_item->id) }}"
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group input-group-sm">
                                                <input type="text"
                                                    ...
                                                    value="{{ $sales_invoices_payments_edit->discount ?? 0 }}" />
                                            </div>
                                            @error('discount')
                                                <div class="invalid-feedback"> {{ $message }} </div>
                                            @enderror
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"
                                                ...
                                                value="{{ $sales_invoices_payments_edit->balance_to_be_pay ?? 0 }}" />
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"
                                                ...
                                                value="{{ $sales_invoices_payments_edit->balance_to_pay_date ?? '' }}" />
...
@section('script')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\UpdateCashSale', '#edit-form') !!}
@endsection
