                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-lg-9 col-sm-12 py-5">
                                <form action="{{ route('import_shipping_chassis_management') }}" method="POST" enctype="multipart/form-data"
                                    id="import-form">
                                    @csrf

                                    <input type="hidden" name="arrival_item_id" value="{{ $arrival_item->id }}">
                                    <input type="hidden" name="purchase_item_id" value="{{ $arrival_item->purchase_item_id }}">
                                    <input type="hidden" name="purchase_order_id" value="{{ $arrival_item->purchase_order_id }}">
                                    <input type="hidden" name="arrival_information_id" value="{{ $arrival_item->arrival_information_id }}">
